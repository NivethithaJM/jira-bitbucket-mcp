...
export const addBitbucketCommentToolDefinition = {
...
export async function addBitbucketComment(prUrl, comment) {
    try {
        ...
        const response = await bitbucketClient.post(`/repositories/${workspace}/${repository}/pullrequests/${prId}/comments`, commentPayload);
        return {
            ...response.data,
...
//# sourceMappingURL=bitbucket-comments.js.map